...
//    }
    ...
    @Basic
    @Column(name = "FCORE")
    public Double getFcore() {
        return fcore;
    }

    public void setFcore(Double fcore) {
        this.fcore = fcore;
    }
...
//    }
    ...
    public Double getUnitSellPack() {
        return unitSellPack;
    }

    public void setUnitSellPack(Double unitSellPack) {
...
//    }
    ...
    public boolean equals(Object o) {
        ...
        FordPtEntity that = (FordPtEntity) o;
...
//                ", pipp='" + pipp + '\'' +
//                ", termeligibility='" + termeligibility + '\'' +
//                ", lstrtrndate=" + lstrtrndate +
//                ", pippProgPrice=" + pippProgPrice +
                ", brand='" + brand + '\'' +
//                ", discount=" + discount +
//                ", allowance='" + allowance + '\'' +
                ", flist=" + flist +
...
//                ", prcchgdir='" + prcchgdir + '\'' +
                ", d2D='" + d2D + '\'' +
                ", d2DPrice=" + d2DPrice +
                ", unitSellPack=" + unitSellPack +
                ", description='" + description + '\'' +
//                ", productLine='" + productLine + '\'' +
//                ", marketProductLine='" + marketProductLine + '\'' +
                ", collision='" + collision + '\'' +
//                ", lsd='" + lsd + '\'' +
//                ", newpart='" + newpart + '\'' +
//                ", natfltprc=" + natfltprc +
//                ", suppdirship='" + suppdirship + '\'' +
//                ", pwrtrncomp='" + pwrtrncomp + '\'' +
//                ", prtreldate=" + prtreldate +
                ", sellpkqty=" + sellpkqty +
//                ", pdcType='" + pdcType + '\'' +
//                ", doi='" + doi + '\'' +
//                ", fltprc=" + fltprc +
